...
class HomeController extends AbstractController
{
    ...
    {
        // $offers = $offerRepository->find([], ['id' => 'DESC']);

        $tags = $tagRepository->findAll();

        $page = $request->query->get('page', 1);

        $offers = $offerRepository->findPaginatedOffer($page,8);
    ...
    public function entreprises(EntrepriseProfilRepository $entrepriseProfilRepository): Response
    {

        $entreprises = $entrepriseProfilRepository->findAll();
