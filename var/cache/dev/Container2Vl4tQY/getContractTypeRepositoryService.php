 ...
 */
class getContractTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContractTypeRepository' shared autowired service.
     *
     * @return \App\Repository\ContractTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContractTypeRepository.php';

        return $container->privates['App\\Repository\\ContractTypeRepository'] = new \App\Repository\ContractTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
