 ...
 */
class getEntrepriseProfilRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntrepriseProfilRepository' shared autowired service.
     *
     * @return \App\Repository\EntrepriseProfilRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntrepriseProfilRepository.php';

        return $container->privates['App\\Repository\\EntrepriseProfilRepository'] = new \App\Repository\EntrepriseProfilRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
