 ...
 */
class getHomeSettingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HomeSettingRepository' shared autowired service.
     *
     * @return \App\Repository\HomeSettingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HomeSettingRepository.php';

        return $container->privates['App\\Repository\\HomeSettingRepository'] = new \App\Repository\HomeSettingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
